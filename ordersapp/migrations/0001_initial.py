# Generated by Django 3.2.8 on 2022-07-10 09:13
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ...
        ('mainapp', '0002_rename_accomodation_accommodation'),
    ]
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(choices=[('FM', 'формируется'), ('STP', 'отправлен на сборку'), ('PRD', 'обрабатывается'), ('PD', 'оплачен'), ('RDY', 'подтверждён размещением'), ('CNL', 'отменён')], default='FM', max_length=3, verbose_name='статус')),
